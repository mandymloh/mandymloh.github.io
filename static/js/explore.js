...
searchBar.addEventListener('keyup', (e) => {
    ...
    const filteredRecipes = daRecipes.filter((recipe) => {
        return (
            ...
            recipe.keywords.toLowerCase().includes(searchString)            
        );
    });
...
const loadRecipes = async () => {
    try {
        const res = await fetch('explore_cards.json');
        ...
        .map((recipe) => {
            ...
            <div class="col-md-4">
                <a href="${recipe.url}" style = "text-decoration: none; color: black;">
                    <div class="row g-0 border rounded flex-md-row mb-4 shadow-sm position-relative" style = "border-color: #E3E8E6 !important; box-shadow: 0 2px 5px 0 rgba(227, 232, 230, 1), 0 5px 15px 0 rgba(227, 232, 230,.1) !important; border-radius: 10px;">
                        <img class = "pull-right img-fluid" src="${recipe.image}" alt="Recipe image" style = "max-width: 100%; height: auto; border-radius: 10px;">
